<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="/">
            <img src="/image/<?= $profile[0]['flogo']; ?>" alt="Logo" width="auto" height="24" class="d-inline-block align-text-top">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex gap-3">
                ...
                <a class="btn btn-primary" href="/gabung" role="button">Gabung</a>
            </div>
        </div>
    </div>
</nav>